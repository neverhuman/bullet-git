...
| contract | `ops/ci/contract.sh` | nonzero configured 171-case workspace/daemon partition, real Git and daemon round trip, JUnit, and six exact corpus-replay outcomes | rustc 1.97.1, cargo-nextest 0.9.137, Git |
